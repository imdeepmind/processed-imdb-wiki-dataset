...
cols = ['dob', 'photo_taken', 'full_path', 'gender', 'name', 'face', 'face_score1', 'face_score2', 'imdb_id']
...
theData = np.vstack((dob,photo_taken,path,genders,names,face,face_score1,face_score2, celeb_id)).T
